...
i.delete(t)
let o=n.indexOf(t)
return n.splice(o,1),s?.has(t)?(s.delete(t),!1):(e.localState&&(o=e.localState.indexOf(t),e.localState.splice(o,1)),!0)}(n,r)&&y(e,t,i)):O(n,r)&&y(e,t,i):s?(n.remoteMembers.delete(r),n.localMembers.delete(r)):r&&n.localMembers.has(r)&&n.localMembers.delete(r)}function C(e,t){e._scheduleLocalSync(t)}function M(e,t,i=!1){const s=e.get(t.record,t.field)
...
e.localState.splice(i,1)}return!0}function q(e,t,i,r){d(r)?M(e,{op:"replaceRelatedRecord",record:t,field:i,value:r.remoteState},!1):k(e,{op:"replaceRelatedRecords",record:t,field:i,value:r.remoteState.slice()},!1)}function D(e){const t={}
...
t.splice(i,1)})),e.additions?.forEach((e=>{t.push(e)})),e.localState=t,e.isDirty=!1,t}(e)),e.links&&(t.links=e.links),e.meta&&(t.meta=e.meta),t}function j(e,t,i,r,s,n){T(e,0,t,r,s??null)&&S(e,r,t.definition.inverseKey,i,n)}function P(e,t,i,r,s){O(t,r)&&A(e,r,t.definition.inverseKey,i,s)}function F(e){switch(typeof e){case"object":return e
...
if(r)return c(s,d,i,r),r.rhs_modelNames.push(d),r}}return s[d][i]=null,null}const f=R(u)
let p,y
const g=f.type
if(null===f.inverseKey?p=null:(y=function(e,t,i){const r=e.schema.fields(t).get(i)
return r?r.options.inverse:null}(o(n),t,i),p=!y&&f.isPolymorphic&&f.inverseKey?{kind:"belongsTo",key:f.inverseKey,type:d,isAsync:!1,isImplicit:!1,isCollection:!1,isPolymorphic:!1}:y?R(n.schema.fields({type:g}).get(y)):null),!p){y=v(d,i),p={kind:"implicit",key:y,type:d,isAsync:!1,isImplicit:!0,isCollection:!0,isPolymorphic:!1},w(f,p),w(p,f)
...
e.update({op:"replaceRelatedRecords",record:o,field:t.field,value:N(c.data,i)},!0)}else e.update({op:"replaceRelatedRecord",record:o,field:t.field,value:c.data?e.store.identifierCache.upgradeIdentifier(c.data):null},!0)
...
if(i.links=c.links,c.links.related){const t=F(c.links.related),i=e&&e.related?F(e.related):null,a=i?i.href:null
...
this._updatedRelationships=new Set,e.forEach((e=>y(this,e.identifier,e.definition.key)))}destroy(){I.delete(this.store),this.identifiers.clear(),this.store=null,this.isDestroyed=!0}}function z(e,t){t.forEach((t=>{t.forEach((t=>{!function(e,t){for(let i=0;i<t.length;i++)e.update(t[i],!0)}(e,t)}))}))}function L(e){d(e)?(e.localState=null,e.remoteState=null,e.state.hasReceivedData=!1,e.state.isEmpty=!0):(e.remoteMembers.clear(),e.remoteState=[],e.additions=null,e.removals=null,e.localState=null)}function x(e,t){const{identifier:i}=t,{inverseKey:r}=t.definition
...
let i=I.get(t)
return i||(i=new $(t),I.set(t,i),o(t)._graph=i),i}},910:(e,t,i)=>{i.d(t,{F:()=>p,S:()=>f,a:()=>l,b:()=>c,c:()=>u,i:()=>d,n:()=>h,u:()=>_})
